...
`Player` is a simple drop in component for playing local or streaming remote media on iOS, written in Swift. It also makes customization of loading and interaction much easier.
